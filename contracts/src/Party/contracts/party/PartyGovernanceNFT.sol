...
contract PartyGovernanceNFT is PartyGovernance, ERC721, IERC2981 {
    ...
    event PartyTransfer(address indexed owner, address indexed to, uint256 amount, uint256 intrinsicTokenVotingPower);
    ...
    function mint(
        ...
        emit PartyTransfer(address(0), owner, tokenId, votingPowerByTokenId[tokenId]);
    }
    ...
    function _burnAndUpdateVotingPower(
        ...
        for (uint256 i; i < tokenIds.length; ++i) {
            ...
            emit PartyTransfer(msg.sender, address(0), tokenId, votingPowerByTokenId[tokenId]);
        }
    ...
    function transferFrom(address owner, address to, uint256 tokenId) public override {
        ...
        emit PartyTransfer(owner, to, tokenId, votingPowerByTokenId[tokenId]);
    }
